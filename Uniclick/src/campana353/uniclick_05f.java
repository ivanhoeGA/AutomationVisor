...
public class uniclick_05f {
	...
	public static void main(String[] args) throws InterruptedException {
		// Abrir el browser y navegar a la url
				...
				// Se carga el documento para "Identificación oficial vigente"
				driver.findElement(By
						.xpath("//*[@id='btnSubirFile'][contains( @data-campo, 'Documentos_del_Avall_Identificación_oficial_vigente')]"))
						.click();
				...
				driver.findElement(By
						.xpath("//*[@id='btnSubirFile'][contains( @data-campo, 'Documentos_del_Avall_Cédula_de_identificación_fiscal')]"))
						.click();
				driver.findElement(By.name("upl")).sendKeys("C:\\b2c64374-15e6-4aa7-af9b-b94c537a875c.pdf");
				Thread.sleep(2000);
				driver.findElement(By.xpath("//*[contains( @value, 'Guardar')]")).click();
				...
				// Se carga el documento para "Identificación del Aval (anexo)"
				driver.findElement(By
						.xpath("//*[@id='btnSubirFile'][contains( @data-campo, 'Documentos_del_Avall_Identificación_del_Aval_anexo')]"))
						.click();
				driver.findElement(By.name("upl")).sendKeys("C:\\b2c64374-15e6-4aa7-af9b-b94c537a875c.pdf");
				Thread.sleep(2000);
				driver.findElement(By.xpath("//*[contains( @value, 'Guardar')]")).click();
				...
				//Avanzar a información de la empresa hacia la etapa de Análisis.
				WebElement formalizacionFinish = driver.findElement(By.id("eAuth"));
				formalizacionFinish.click();
				
				System.out.println("Se debió de haber cambiado de etapa");
